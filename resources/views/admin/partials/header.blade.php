...
<head>
	...
	<!-- FAVICONS ICON -->
	<!-- <link rel="shortcut icon" type="admin/image/png" href="/admin1/images/favicon.png"> -->
	
	<link href="/admin1/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
	<link href="/admin1/vendor/swiper/css/swiper-bundle.min.css" rel="stylesheet">
	<link href="/admin1/vendor/swiper/css/swiper-bundle.min.css" rel="stylesheet">
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/noUiSlider/14.6.4/nouislider.min.css">
	<link href="/admin1/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
	<link href="https://cdn.datatables.net/buttons/1.6.4/css/buttons.dataTables.min.css" rel="stylesheet">
	<link href="/admin1/vendor/bootstrap-datetimepicker/css/bootstrap-datetimepicker.min.css" rel="stylesheet">
	
	<!-- tagify-css -->
	<link href="./admin1/vendor/tagify/dist/tagify.css" rel="stylesheet">
...
<body>
    ...
    <div id="main-wrapper">
        ...
        <div class="nav-header" style="background-color: #df5900">
            <a href="/" class="brand-logo">
				...
				<span style="color: white; font-family: garamond; font-weight: 700; font-size: 16px">Adekolme Nigeria Ltd</span>
				<!-- <img src="/banner/logo_a.png"style="width: 100px; height: auto"  alt=""> -->
            </a>
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
						<div class="header-left">
							...
							<span style="font-family: garamond; font-size: 20px; font-weight: 400"> | Welcome {{Auth::guard('admin')->user()->name}}</span>
                            </div>
						</div>
